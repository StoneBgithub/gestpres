...
<head>
    ...
    <script src="./js/scan-presence.js"></script>
...
<body>
    ...
    <main class="container mx-auto px-6 py-12">
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-8">
                ...
                <p class="text-lg text-ui-text-muted mb-6">Scannez votre code QR ou entrez votre matricule pour
                    enregistrer votre présence.</p>
            </div>
            ...
            <div id="qr-container"
                class="method-container bg-white rounded-3xl shadow-xl p-6 md:p-8 card-shine border border-congo-green-light">
                ...
                <div class="text-center">
                    <p class="text-sm text-ui-text-muted mb-4">Placez le QR code devant la caméra pour l'enregistrement
                        automatique</p>
            ...
            <div id="manual-container"
                class="method-container bg-white rounded-3xl shadow-xl p-6 md:p-8 card-shine border border-congo-yellow">
                <div class="flex items-center mb-6">
                    <div class="w-12 h-12 rounded-xl gradient-bg flex items-center justify-center mr-4 pulse">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <h2 class="text-2xl font-bold text-congo-green-dark">Saisir votre présence</h2>
                </div>

                <form id="presence-form" class="space-y-6">
                    <!-- Ligne Service + Bureau -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <!-- Service -->
                        <div>
                            <label for="service"
                                class="block text-sm font-medium text-ui-text-muted mb-1">Service</label>
                            <select id="service" name="service"
                                class="select2 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-congo-green focus:border-congo-green"
                                required>
                        ...
                        <!-- Bureau -->
                        <div>
                            <label for="bureau" class="block text-sm font-medium text-ui-text-muted mb-1">Bureau</label>
                            <select disabled id="bureau" name="bureau" class="select2 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-congo-green focus:border-congo-green
                                res>
                                <option value="">Rechercher un bureau</option>
                                <!-- Options dynamiques -->
                            </select>
                        </div>
                    </div>
                    ...
                    <div class=" relative mb-4">
                                <label for="agent"
                                    class="block text-sm font-medium text-ui-text-muted mb-1">Agent</label>
                        ...
                        <!-- Date de présence -->
                        <div class="relative mb-4">
                            <label for="presence_date" class="block text-sm font-medium text-ui-text-muted mb-1">Date de
                                présence</label>
                        ...
                        <!-- Heure de présence -->
                        <div class="relative mb-4">
                            <label for="presence_time" class="block text-sm font-medium text-ui-text-muted mb-1">Heure
                                de
                                présence</label>
                        ...
                        <button type="submit"
                            class="w-full custom-btn font-medium py-3 px-4 rounded-xl flex items-center justify-center">
            ...
            <div class="text-center mt-8">
                <a href="./../index.php"
                    class="text-congo-green hover:text-congo-green-light font-medium flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="modal-container bg-white rounded-3xl shadow-2xl max-w-md w-full mx-4 overflow-hidden card-shine">
            <div class="relative">
                ...
                <div class="absolute top-0 right-0 m-4">
                    <span id="scan-type"
                        class="px-3 py-1 bg-white text-congo-green rounded-full text-sm font-medium">Type de scan</span>
                </div>
                <div class="absolute top-12 inset-x-0 flex justify-center">
                    <div class="w-24 h-24 rounded-full border-4 border-white overflow-hidden bg-white">
                        <img id="agent-photo" src="https://i.pravatar.cc/150?img=10" alt="Photo de l'agent"
                ...
                <div class="pt-16 p-6 text-center">
                    ...
                    <p class="text-sm text-ui-text-muted">Cette fenêtre se fermera automatiquement dans <span
                            id="countdown">10</span> secondes</p>
                </div>
    ...
    <div id="error-modal" class="modal">
        <div class="modal-container bg-white rounded-3xl shadow-2xl max-w-md w-full mx-4 overflow-hidden card-shine">
            <div class="relative">
                ...
                <div class="absolute top-12 inset-x-0 flex justify-center">
                    <div
                        class="w-24 h-24 flex items-center justify-center rounded-full border-4 border-white bg-red-100">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-congo-red" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="pt-16 p-6 text-center">
                    ...
                    <button id="error-close-btn"
                        class="px-6 py-2 bg-congo-red text-white rounded-xl font-medium hover:bg-red-700 transition-colors">
                        Fermer
                    </button>
                    <p class="text-sm text-ui-text-muted mt-4">Cette fenêtre se fermera automatiquement dans <span
                            id="error-countdown">5</span> secondes</p>
                </div>
    ...
    <footer class="footer-bg text-white py-12">
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-6 md:mb-0 flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-200 mt-2">Solution développée pour la Direction des Systèmes d'Information
                        </p>
                    </div>
                </div>
            ...
            <div class="text-center flex flex-col items-center">
                <p class="text-white text-lg font-medium">© <?php echo date('Y'); ?> Direction des Systèmes
                    d'Information</p>
    ...
    updateDateTime();
    setInterval(updateDateTime, 2000); // Réduit à toutes les 2 secondes
    ...
    function startQRScanner() {
        ...
        html5QrCode.start({
            ...
            .catch((err) => {
                ...
                showErrorModal("Impossible d'accéder à la caméra. Vérifiez les permissions.");
                speakMessage("Impossible d'accéder à la caméra. Vérifiez les permissions.", true);
            });
    }
    ...
    function processPresence(matricule = null) {
        ...
        if (!agentId) {
            showErrorModal("Veuillez sélectionner un agent ou scanner un QR code valide.");
            speakMessage("Veuillez sélectionner un agent ou scanner un QR code valide.", true);
            return;
        }

        if (currentMethod === 'manual' && (!presenceDate || !presenceTime)) {
            showErrorModal("Veuillez remplir la date et l'heure pour la soumission manuelle.");
        ...
        fetch('process_presence.php', {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    if (currentMethod === 'manual') {
                        if (document.getElementById('agent')) document.getElementById('agent').value = '';
                        if (document.getElementById('presence_date')) document.getElementById('presence_date')
                            .value = '';
                        if (document.getElementById('presence_time')) document.getElementById('presence_time')
                            .value = '';
                    }
                    ...
                    speakMessage(data.message || "Une erreur s'est produite lors du traitement de la présence.",
                        true);
                }
            })
            .catch(error => {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Définir l'état initial pour afficher le scanner QR
        switchMethod('qr');
        ...
        scanBtns.forEach(btn => {
            btn.classList.add('custom-btn', 'py-2', 'px-4', 'rounded-xl', 'flex', 'items-center',
