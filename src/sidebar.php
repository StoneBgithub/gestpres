...
if ($role === 'admnistrateur') {
    ...
    echo '<li>';
    echo '<a href="dashboard.php?page=' . htmlspecialchars($page_name) . '" class="sidebar-menu flex items-center px-4 py-3 rounded-xl hover:bg-congo-yellow-pale hover:text-congo-green-dark transition-all duration-300 card-shine ' . $active_class . '" data-page="' . htmlspecialchars($page_name) . '">';
