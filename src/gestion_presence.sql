...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 11 juil. 2025 à 17:57
...
INSERT INTO `absence` (`id`, `agent_id`, `date_debut`, `date_fin`, `id_type_absence`, `justificatif`, `id_statut`, `date_saisie`, `description`) VALUES
(1, 127, '2025-07-11', '2025-07-17', 4, 'hdj', 2, '2025-07-11 13:08:46', 'xsbj,kx'),
(2, 129, '2025-07-11', '2025-07-18', 2, 'image.pdf', 1, '2025-07-11 14:28:52', 'appendicite'),
(4, 131, '2025-07-11', '2025-07-25', 5, 'image.jpg', 3, '2025-07-11 15:36:11', 'gchjk');
...
(59, 12, 'supprimer', '{\"nom\":\"SAMBA\",\"prenom\":\"Jacky Landry\",\"matricule\":\"135S688E\",\"email\":\"grafanachallenge@gmail.com\",\"telephone\":\"066364688\",\"bureau_id\":\"2\"}', '2025-07-09 17:36:53', 0);
...
(10, 125, '123456', '2025-05-05 10:48:47', '2025-05-05 10:48:47', 'activé', 6, 'déconnecté'),
(11, 126, '123456', '2025-05-05 10:49:09', '2025-05-05 10:49:09', 'activé', 7, 'déconnecté'),
(12, 148, '123456', '2025-05-05 10:49:39', '2025-05-05 10:49:39', 'activé', 5, 'déconnecté'),
(13, 216, '123456', '2025-06-19 19:52:33', '2025-06-19 19:52:33', 'activé', 8, 'déconnecté'),
(14, 133, '$2y$10$H84uZ/uIPfqFCEA/koxdluySH767jJPM4fKA0h.8lFd8hN8htATOS', '2025-07-10 01:22:23', '2025-07-10 01:22:23', '', 5, 'déconnecté');
...
CREATE TABLE `role` (
  `id` int(11) NOT NULL,
  `libelle` enum('secrétaire','directrice','chef de service','admnistrateur') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
