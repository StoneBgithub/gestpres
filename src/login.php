...
<head>
    ...
    .gradient-bg {
        background: linear-gradient(135deg, #5CBF15 0%, #014023 100%);
        /* Vibrant to dark green */
    }

    .error-gradient-bg {
        background: linear-gradient(135deg, #D91A1A 0%, #A6882E 100%);
        /* Red to dark yellow */
    }

    .custom-btn {
        transition: all 0.3s ease;
        background: linear-gradient(135deg, #038C33 0%, #5CBF15 100%);
        /* Main to vibrant green */
        color: white;
    }
    ...
    input:focus {
        outline: none;
        box-shadow: 0 0 0 3px rgba(92, 191, 21, 0.3);
        /* Vibrant green focus ring */
    }
    ...
    .logo-glow {
        filter: drop-shadow(0 0 10px rgba(92, 191, 21, 0.5));
        /* Vibrant green glow */
    }
    </style>
</head>
        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
            <div class="gradient-bg p-6 text-white text-center">
                <div class="flex items-center justify-center mb-4">
                    <img src="./public/logo.svg" alt="Armoirie de la DSI" class="w-16 h-16 logo-glow pulse"
                        aria-label="Logo de la Direction des Systèmes d'Information">
                </div>
            ...
            <div class="p-6 md:p-8">
                ...
                <form
                    action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . (isset($_GET['from']) ? '?from=' . htmlspecialchars($_GET['from']) : ''); ?>"
                    method="post" aria-label="Formulaire de connexion">
                    <div class="mb-6">
                        <label for="email" class="block text-sm font-medium" style="color: #0D0D0D;">Email
                            professionnel</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" style="color: #A6882E;"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" />
                                </svg>
                            </div>
                            <input type="email" id="email" name="email" class="w-full pl-10 pr-4 py-2 border rounded-lg"
                                style="border-color: #E9F2A0;" placeholder="nom@entreprise.com" required>
                        </div>
                    </div>

                    <div class="mb-6">
                        <label for="password" class="block text-sm font-medium" style="color: #0D0D0D;">Mot de
                            passe</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" style="color: #A6882E;"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 11c0 1.104-.896 2-2 2s-2-.896-2-2 2-4 2-4 2 .896 2 2zM16 18H8m8 0c0 1.104-.896 2-2 2h-4c-1.104 0-2-.896-2-2m8 0v-4a4 4 0 00-4-4H8a4 4 0 00-4 4v4" />
                                </svg>
                            </div>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <a href="forgot-password.php" class="text-sm font-medium" style="color: #038C33;"
                            onmouseover="this.style.color='#5CBF15'" onmouseout="this.style.color='#038C33'">
                            Mot de passe oublié ?
                        </a>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <a href="./../index.php" class="font-medium flex items-center justify-center"
                        style="color: #038C33;" onmouseover="this.style.color='#5CBF15'"
                        onmouseout="this.style.color='#038C33'" aria-label="Retour à l'accueil">
