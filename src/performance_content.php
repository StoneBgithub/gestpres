...
// Récupérer les services et bureaux pour les filtres
...
<div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row md:items-end space-y-4 md:space-y-0 md:space-x-4">
            <div class="filter-container">
                ...
                <div>
                    ...
                    <select id="service" class="focus:ring-congo-green focus:border-congo-green block w-full sm:text-sm border-gray-300 rounded-md py-2 px-4 border">
                        ...
                        <?php foreach ($services as $svc): ?>
                            <option value="<?php echo htmlspecialchars($svc['id']); ?>"><?php echo htmlspecialchars($svc['libele']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div>
                ...
                <div>
                    ...
                    <select id="period" class="focus:ring-congo-green focus:border-congo-green block w-full sm:text-sm border-gray-300 rounded-md py-2 px-4 border">
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6" id="global-stats">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Retards/Départs anticipés</th>
                    </tr>
                </thead>
...
/* Assurer un espacement suffisant entre l'avatar et le nom/téléphone */
.ml-4 {
    margin-left: 1rem;
}
...
.bg-yellow-400 {
    background-color: #FBBF24; /* Or */
}
.bg-orange-700 {
    background-color: #C2410C; /* Bronze */
}
...
#agents-ranking td:nth-child(7) {
    padding-left: 0.3rem; /* Réduit l'espace avant la colonne des retards/départs anticipés */
}
</style>