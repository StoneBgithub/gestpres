...
if ($isAjax) {
    ...
    $valid_pages = ['dashboard_content', 'agents_content', 'presence_content', 'absence_content', 'performance_content','historique_content','compte_content', 'parametrage_content'];
                ...
                <div class="px-6 py-4 flex justify-between items-center">
                    <h1 id="page-title" class="text-2xl font-bold text-gray-800 font-display">
                        ...
                        $menu_items = [
                            ...
                            'absence_content' => 'Gestion des Absences',
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center">
                            <img src="<?php echo $profile_image; ?>" alt="Photo de profil"
                                class="h-11 w-11 rounded-full object-cover shadow-sm">
                            <span
                                class="ml-2 text-gray-700 font-medium font-body"><?php echo htmlspecialchars(ucfirst($user['role'])); ?></span>
                        </div>
                        <?php
                        } else {
