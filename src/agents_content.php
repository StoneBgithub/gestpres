...
<div
    ...
    <form action="#" method="get" class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="flex items-end space-x-2">
            ...
            <button type="button"
                class="add-agent-btn px-3 py-2 text-sm gradient-bg text-white rounded-lg hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition-all flex items-center justify-center">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-all duration-300">
        <div class="p-4">
            ...
            <div class="flex flex-wrap gap-2 pt-3 border-t border-gray-100">
                ...
                <button
                    class="qr-agent-btn px-2 py-1 text-xs sm:text-sm gradient-bg text-emerald-600 rounded-lg hover:bg-emerald-100 transition-colors"
                    data-id="<?= $agent['id'] ?>">
    ...
    <div class="bg-white rounded-lg shadow-2xl w-full max-w-md sm:max-w-lg md:max-w-2xl p-4 sm:p-6 transform transition-all duration-300 scale-95 opacity-0"
        ...
        <form id="agentForm" action="?page=agents_content" method="post" enctype="multipart/form-data"
            ...
            <div class="mt-6 flex justify-end space-x-3">
                ...
                <button type="submit"
                    class="px-3 py-2 text-sm gradient-bg text-white rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all flex items-center">
